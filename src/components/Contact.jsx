...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        window.location.href = `mailto:tejanagasai2005@gmail.com?subject=${subject}&body=${body}`;
                ...
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12">
                    ...
                    <div className="md:w-2/3 bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-xl">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-primary text-white font-bold py-4 rounded-lg hover:bg-orange-600 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-orange-500/25 flex items-center justify-center gap-2"
                            >
